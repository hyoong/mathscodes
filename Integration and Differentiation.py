...
if expression.isalpha() or ' ' in expression:
    print("Please include the multiplication operator (*) between coefficients and variables.")
    expression = input("Enter an expression in terms of x: ")
...
if a and b:
    ...
    print(f"The definite integral of {expression} from {a} to {b} is {definite_integral}")
elif a or b:
    print("Please enter both the lower and upper limits of integration to compute a definite integral.")
